...
init_config = {}
init_config['adel'] = ('r3417', 'major')
init_config['caribu'] = ('r4122','major')
init_config['mtg'] = ('r13066','major')
init_config['rpy2'] = (u'2.5.1','minor')
...
# change the values
ra, rc, rm, rr = 'r5046', 'r5049', 'r18385', u'2.7.0'
init_config = {}
init_config['adel'] = (ra, 'patch')
init_config['caribu'] = (rc,'patch')
init_config['mtg'] = (rm,'patch')
init_config['rpy2'] = (rr,'patch')
endof = {# 'mtg':['5903'],
          'rpy2':['2.3.4'],
          #'caribu':['1022'],
        'adel' : ['1971'],
...
# change the values
ra, rc, rm, rr = 'r5650', 'r5049', 'r18392', u'2.7.0'
init_config = {}
init_config['adel'] = (ra, 'commit')
init_config['caribu'] = (rc,'commit')
init_config['mtg'] = (rm,'commit')
init_config['rpy2'] = (rr,'patch')
endof = {# 'mtg':['5903'],
          #'rpy2':['2.3.4'],
          #'caribu':['1022'],
