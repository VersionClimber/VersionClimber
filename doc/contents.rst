...
- A `PDF <../latex/vflexql.pdf>`_ version of |vflexql| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::vflexql:vflexql>`__ wiki.
